    ...
    reports = [
        {
            ...
            'description': 'Find gaps in customer technology adoption. See which customers are missing spend in key buckets and identify outreach opportunities.',
...
@revenue_bp.route('/revenue/reports/whitespace')
def report_whitespace():
    """Whitespace report: find gaps in customer technology adoption."""
    return render_template('revenue_report_whitespace.html')


@revenue_bp.route('/api/revenue/whitespace')
...
@revenue_bp.route('/api/revenue/whitespace/reverse/<int:customer_id>')
...
@revenue_bp.route('/api/revenue/whitespace/penetration')
